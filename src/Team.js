...
import kairalg from "./prof ai lg.png"
import kairamd from "./prof ai md.png"
import kairasm from "./prof ai sm.png"
import kairaxs from "./prof ai xs.png"
...
style={{float: "right", paddingTop: 50}}></ResponsiveImgMaterialUi>
    ...
    maxHeight: "fit-content"}}>
                            ...
                            <Typography style={{ color: "white",fontSize: "1.15vw",  textAlign: "left", paddingTop: 20}}>
                                Besides cancer prediction Kai is currently supporting Dr. Miller to diagnose diseases such as asthma, diabetes and skin disease.
    </Typography>
    </Grid>
    </Grid>
                        </Grid>
